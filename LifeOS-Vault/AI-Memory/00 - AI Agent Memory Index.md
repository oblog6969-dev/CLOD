...
| **docs/ files** | Design docs, decision log, session notes — repo root `docs/` | [[Decisions/Decisions Log\|Project Documentation Index]] |
...
- **Frameworks:** [[Frameworks/Tech Stack]], [[Frameworks/Human Development Frameworks]]
